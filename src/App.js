  ...
  render() {
    ...
    const text = 
        <div> 
            ...
            <p>
               But visitors will be able to see the original
               <b> 3,600</b>
               -pound torch in all its glory at a new Statue of Liberty Museum, which will open on Liberty Island in May 2019. The torch was transported there by truck last week, along with a replica model of Lady Liberty's face.
            ...
            <p>
                Not only is the Statue of Liberty the symbol of New York City, she is also a UNESCO World Heritage site under the designation of 
                <b>
            ...
            <p>
               what awkwardly, she arrived a decade too late. Nevertheless, President Grover Cleveland formally unveiled her in 1886.
            ...
            <p>
               <q>The original torch is a beautiful object of art and exemplifies the American ideals of freedom and democracy,</q> says John Piltzecker, superintendent of the Statue of Liberty National Monument. That symbolic spirit was bolstered by the decision to inscribe Emma Lazarus' poem <b>"The New Colossus"</b> on the statue's pedestal, which gave Lady Liberty one of her nicknames, <q>Mother of Exiles.</q>
            ...
            <p>
                 When completed, the Statue of Liberty Museum will be 
                 <b>26,000 </b>
                  square feet of history, inspiration and deeper analysis of the statue's symbolism both in the US and around the world.
            </p>
            <p>
               The <em>"inspiration gallery," </em>
               which is where the torch will live, will have floor-to-ceiling glass windows looking out at Lower Manhattan, including the World Trade Center.
            </p>
    ...
    return (
      <div className="App">
        <Article author={author} title={title} date={date}>
        {text}
        </Article>
      </div>
    );
